...
def dcm_to_jpg(path):
    try:
        ...
        print(f"Convert Image error {path}: {e}")
        return None
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="./data/original/rsna-pneumonia-detection-challenge/",
        help="Path to the dataset",
    )
    parser.add_argument(
        "--output",
        type=str,
        default="./data/processed/rsna/",
    ...
    print("\nRSNA dataset processed successfully!")
